  ...
  return (
    <section className="relative min-h-[600px] lg:min-h-[700px] flex items-center bg-gradient-to-br from-navy via-navy-dark to-teal-dark overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-teal/15 blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 rounded-full bg-sky/15 blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 py-20 lg:py-28 w-full">
        <div className="max-w-3xl">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose/15 border border-rose/30 mb-8 shadow-[0_0_20px_rgba(244,63,94,0.2)]"
          >
            ...
            <a href="tel:065249036" className="text-sm font-bold text-white hover:underline" dir="ltr">
              {dict.emergencyPhone}
            </a>
          </motion.div>
          ...
          >
            ...
            <a href="tel:065249036" className="text-sm hover:text-white transition-colors" dir="ltr">
              {dict.emergencyPhone}
            </a>
          </motion.div>
        </div>

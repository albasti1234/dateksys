...
import { fadeIn } from "@/lib/showcase-animations";
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <p
          className="text-xs"
          style={{ color: "rgba(240,237,230,0.3)", fontFamily: "var(--font-dm-sans)" }}
        >
          &copy; {new Date().getFullYear()} DatekSys. All rights reserved.
        </p>

...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: { ar: "دار المسكن", en: "Dar Al-Maskan" },
    client: { ar: "دار المسكن للعقارات الفاخرة", en: "Dar Al-Maskan Luxury Real Estate" },
    year: 2026,
    status: "live",
    description: {
      ar: "منصة عقارات فاخرة سينمائية مع جولات افتراضية، حاسبة تمويل، ملفات وكلاء، ونظام حجز معاينات.",
      en: "Cinematic luxury real estate platform with virtual tours, mortgage calculator, agent profiles, and viewing scheduler.",
    },
    techStack: ["Next.js 16", "React 19", "TypeScript", "Tailwind CSS", "Framer Motion"],
    features: [
      ...
      { ar: "حجز معاينات", en: "Viewing scheduler" },
      { ar: "مجلة عقارية", en: "Real estate journal" },
      { ar: "ثنائي اللغة عربي/إنجليزي", en: "Bilingual AR/EN" },
    ],
    ...
    portals: [
      {
        ...
        icon: "Globe",
        description: {
          ar: "موقع العقارات الفاخرة مع القوائم والتفاصيل وحاسبة التمويل.",
          en: "Luxury real estate website with listings, details, and mortgage calculator.",
        },
        screenshots: ["/showcase/school-demo.png"],
        url: "/demos/realestate",
      },
    ],
  },
  {
